...
Projeto com objetivo de implementar de forma progressiva uma aplicação web com a finalidade de listar todos os desenhos e animações que o usuário ja assistiu(ex. nome, notas, quantidade de epsódios, etc),
